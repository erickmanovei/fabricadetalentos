        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "ajaxUserCallPhp": {
                    ...
                    "alertTextOk": "* Este usuário é válido",
                    "alertText": "* Este usuário já está sendo usado. Favor escolher outro.",
                    "alertTextLoad": "* Validando, aguarde..."
                },
				
				
				// --- CUSTOM RULES -- Those are specific to the demos, they can be removed or changed to your likings
                "ajaxPercentualRestante": {
                    "url": "phpajax/ajaxPercentualRestante.php",
                    // you may want to pass extra data on the ajax call
                    "extraData": "name=eric",
                    // if you provide an "alertTextOk", it will show as a green prompt when the field validates
                    "alertTextOk": "* Este percentual é válido",
                    "alertText": "* Este percentual somado aos demais percentuais ultrapassam 100%.",
                    "alertTextLoad": "* Validando, aguarde..."
                },
